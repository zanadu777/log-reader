...
namespace LogReader
{
    partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            _mruMenu = new MruStripMenuInline(recentFilesToolStripMenuItem, recentFile1ToolStripMenuItem, new MruStripMenu.ClickedHandler(OnMruFile), _mruRegKey, loadFromRegistry, 10);
        }
